...
const (
	WeatherService_ProcessTweet_FullMethodName = "/weather.WeatherService/ProcessTweet"
)
...
type WeatherServiceClient interface {
	ProcessTweet(ctx context.Context, in *WeatherTweet, opts ...grpc.CallOption) (*WeatherResponse, error)
}
...
func (c *weatherServiceClient) ProcessTweet(ctx context.Context, in *WeatherTweet, opts ...grpc.CallOption) (*WeatherResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WeatherResponse)
	err := c.cc.Invoke(ctx, WeatherService_ProcessTweet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	ProcessTweet(context.Context, *WeatherTweet) (*WeatherResponse, error)
...
func (UnimplementedWeatherServiceServer) ProcessTweet(context.Context, *WeatherTweet) (*WeatherResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ProcessTweet not implemented")
}
...
func _WeatherService_ProcessTweet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WeatherTweet)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WeatherServiceServer).ProcessTweet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WeatherService_ProcessTweet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).ProcessTweet(ctx, req.(*WeatherTweet))
	}
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ProcessTweet",
			Handler:    _WeatherService_ProcessTweet_Handler,
		},
	},
